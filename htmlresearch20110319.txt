...
- From Opera Software:
	- [Håkon Wium Lie](http://people.opera.com/howcome/), CTO; used to work for Tim Berners-Lee, creator of the Web, at both CERN, then the W3C
...
- From the Mozilla Corporation:
	...
	- [Johnny Stenbäck](http://en.wikipedia.org/wiki/Johnny_Stenbäck), Developer
- From Google Inc.:
